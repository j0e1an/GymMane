      ...
      child: StatefulBuilder(
        builder: (sheetCtx, setSheet) {
          ...
          Future<void> pickMedia() async {
            try {
              final picked = await pickLocalFile(accept: 'image/*,video/*');
              final path = picked == null
                  ? null
                  : await localPathFor(path: picked.path, bytes: picked.bytes, name: picked.name);
                        ...
                        children: [
                          Container(
                            ...
                            child: mediaIsVideo
                                ...
                                : Center(child: LocalImage(mediaPath!, fit: BoxFit.contain, alignment: Alignment.center)),
                          ),
                          Positioned(
                            top: 8,
                            right: 8,
