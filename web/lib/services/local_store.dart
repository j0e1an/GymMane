...
class Store {
  ...
  String get _key {
    final id = WebSession.userId;
    if (id == null || id.isEmpty) return 'gymmane_v1';
    return 'gymmane_v1_$id';
  }

  String _noteKey(String key) {
    final id = WebSession.userId;
    if (id == null || id.isEmpty) return 'gm_$key';
    return 'gm_${id}_$key';
  }
  ...
  String? note(String key) => _prefs?.getString(_noteKey(key));

  void setNote(String key, String value) => _prefs?.setString(_noteKey(key), value);
